...
The following \Npdfpages{papers/diffusion.pdf} pages contain the paper:
\vspace*{1cm}
...
\includepdf[scale=.78,pages=-,trim={12mm 10mm 10mm 15mm},pagecommand={}]{papers/diffusion.pdf}