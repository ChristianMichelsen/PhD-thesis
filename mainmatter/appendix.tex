...
The following \Npdfpages{papers/kapk.pdf} pages contain the paper published in Nature 2022:
...
\includepdf[scale=.7,pages=-14,trim={10mm 10mm 10mm 10mm},pagecommand={}]{papers/kapk.pdf}
% XXX
...
The following \Npdfpages{papers/anaemia.pdf} pages contain the draft paper:
...
The following \Npdfpages{papers/SSI_1.pdf} pages contain the report from Statens Serum Institut:
\begin{quote}
...
The following \Npdfpages{papers/SSI_2.pdf} pages contain the report from Statens Serum Institut:
\begin{quote}
